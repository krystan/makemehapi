...
module.exports = function (request, reply) {
    ...
    if (request.headers['accept'] && (/^application\/vnd\.dataNameapi\.v[0-9]+$/).test(request.headers['accept'])) {

        var version = request.headers['accept'].replace('application/vnd.dataNameapi.', '');
